    ...
    <div class="p-6 max-w-4xl mx-auto">
      ...
      <form [formGroup]="supplierForm" (ngSubmit)="onSubmit()" class="space-y-6">
        <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="flex flex-col">
              ...
              @if (isFieldInvalid('supplier_code')) {
                <small class="text-red-600 mt-1">Supplier code is required</small>
              }
            </div>
            ...
            <div class="flex flex-col">
              ...
              @if (isFieldInvalid('supplier_name')) {
                <small class="text-red-600 mt-1">Supplier name is required</small>
              }
            </div>
        ...
        <div class="flex justify-end gap-3">
          ...
          <button pButton type="submit" [label]="isEditMode ? 'Update' : 'Create'" [loading]="loading" [disabled]="supplierForm.invalid || loading"></button>
        </div>
      </form>
    </div>
  `
