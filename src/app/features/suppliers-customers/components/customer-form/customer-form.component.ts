    ...
    <div class="p-6 max-w-4xl mx-auto">
      ...
      <form [formGroup]="customerForm" (ngSubmit)="onSubmit()" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="flex flex-col">
              ...
              @if (isFieldInvalid('customer_code')) {
                <small class="text-red-600 mt-1">Customer code is required</small>
              }
            </div>
            <div class="flex flex-col">
              ...
              @if (isFieldInvalid('customer_name')) {
                <small class="text-red-600 mt-1">Customer name is required</small>
              }
            </div>
            <div class="flex flex-col md:col-span-2">
              ...
              @if (isFieldInvalid('address')) {
                <small class="text-red-600 mt-1">Address is required</small>
              }
            </div>
            <div class="flex flex-col">
            ...
            <div class="flex flex-col">
              ...
              @if (isFieldInvalid('tax_id')) {
                <small class="text-red-600 mt-1">{{ customerForm.get('tax_id')?.hasError('required') ? 'Tax ID is required' : 'Invalid NPWP format' }}</small>
              }
        ...
        <div class="flex justify-end gap-3">
          ...
          <button pButton type="submit" [label]="isEditMode ? 'Update' : 'Create'" [loading]="loading" [disabled]="customerForm.invalid || loading"></button>
        </div>
      </form>
    </div>
  `
